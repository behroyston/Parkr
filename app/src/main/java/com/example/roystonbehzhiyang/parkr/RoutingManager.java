...
/**
 * Created by Snow December on 2/11/2017.
 */
...
public class RoutingManager {
    ...
    public RoutingManager(GoogleMap insertMap)
    {
        this();
        mMap = insertMap;
    }
    ...
    public void setPoint(LatLng setPoint)
    {
        point = setPoint;
    }
    ...
    protected class FetchUrl extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            RoutingManager.ParserTask parserTask = new RoutingManager.ParserTask();
